/*
  ...
  for video split items. The function gets called for each item.
  ...
  * `itemProps`: props passed to create this item (see VideoSplit.js).
  * `splitProps`: props passed to the split itself (see VideoSplit.js).
...
export default function decorateVideoSplitItem(itemIndex, itemProps, splitProps) {
